var splToken = (function (exports) {
  ...
  function assert$k(value, message) {
  ...
  assert$k.AssertionError = AssertionError$1;
  ...
  inherits$7(AssertionError$1, Error);
  ...
  assert$k.deepEqual = deepEqual$1;
  ...
  assert$k.deepStrictEqual = deepStrictEqual$1;
  ...
  assert$k.notDeepEqual = notDeepEqual$1;
  ...
  assert$k.notDeepStrictEqual = notDeepStrictEqual$1;
  ...
  assert$k.strictEqual = strictEqual$1;
  ...
  assert$k.notStrictEqual = notStrictEqual$1;
  ...
  var require$$0$1 = /*@__PURE__*/getAugmentedNamespace(assert$l);

  const assert$j = require$$0$1;
  ...
  */
  ...
  var _args = [
  	[
  		"elliptic@6.5.4",
  		"/home/tyera_solana_com/solana-program-library/token/js"
  	]
  ];
  ...
  var _spec = "6.5.4";
  var _where = "/home/tyera_solana_com/solana-program-library/token/js";
  var author = {
  	name: "Fedor Indutny",
  ...
  inherits$5(Point$2, Base$2.BasePoint);
  ...
  inherits$5(JPoint, Base$2.BasePoint);
  ...
  inherits$4(Point$1, Base$1.BasePoint);
  ...
  inherits$3(Point, Base.BasePoint);
  ...
  */
  ...
  class u64 extends BN$9 {
    ...
    toBuffer() {
      ...
      assert$k(b.length < 8, 'u64 too large');
    ...
    static fromBuffer(buffer) {
      assert$k(buffer.length === 8, `Invalid buffer length: ${buffer.length}`);
